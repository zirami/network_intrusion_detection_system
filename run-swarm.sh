...
SPARK_TRAIN_ARGUMENTS="--conf spark.hadoop.fs.s3a.endpoint=s3.us-east-1.amazonaws.com --conf spark.hadoop.fs.s3a.access.key=AKIA5FG625EFMAQWC4KQ --conf spark.hadoop.fs.s3a.secret.key=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"
...
SPARK_TEST_ARGUMENTS="--conf spark.network.timeout=300 --conf spark.sql.streaming.metricsEnabled=true --conf spark.hadoop.fs.s3a.endpoint=s3.us-east-1.amazonaws.com
 --conf spark.hadoop.fs.s3a.access.key=AKIA5FG625EFMAQWC4KQ --conf spark.hadoop.fs.s3a.secret.key=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"
